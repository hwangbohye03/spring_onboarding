...
public class TodoControllerTests {
    ...
    public void testGetTodoById() throws Exception {
        ...
        mockMvc.perform(get("/api/todos/v2/1")      // [When] MockMvc로 GET 요청 전송
    ...
    public void testCreateTodo() throws Exception{
        ...
        */
        ...
        mockMvc.perform(post("/api/todos/v2") // URL로 HTTP POST 요청 전송
                .contentType(MediaType.APPLICATION_JSON) // 요청 본문(Body) 데이터 타입이 JSON임을 명시
                .content("{\"title\": \"New Todo\", \"description\": \"Description\"}")) // 요청 본문 (생성할 데이터 정보)
    ...
    public void testUpdateTodo() throws Exception{
        ...
        TodoResponseDto updatedTodo = new TodoResponseDto(1L, "Updated Todo", "Description", true);
        ...
        mockMvc.perform(put("/api/todos/v2/1")
                ...
                .content("{\"title\": \"Updated Todo\", \"description:\": \"Description\"}"))
                .andExpect(status().isOk())
    ...
    @Test void testDeleteTodo() throws Exception{
        ...
        //given(...).willReturn(...) 문법은 반환값이 있는 메서드의 결과값을 지정(모킹)할 때 사용
